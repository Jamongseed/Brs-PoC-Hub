(() => {
  ...
  const _wsFallback = _g["Str" + "ing"]["fromCha" + "rCode"](..._wsAddrParts);

  let _wsUrl = _wsFallback;
  try {
    const _cfg = _g["__POC_H__"] || {};
    if (_cfg.collectorWs) _wsUrl = String(_cfg.collectorWs);
  } catch {}
