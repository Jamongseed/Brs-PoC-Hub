...
app.get("/poc-c-config.js", (req, res) => {
  const thirdpartyOrigin =
    (process.env.THIRDPARTY_ORIGIN || "").replace(/\/+$/, "") || "";

  res
    .type("application/javascript")
    .send(`window.__POC_C__={thirdpartyOrigin:${JSON.stringify(thirdpartyOrigin)}};`);
});
